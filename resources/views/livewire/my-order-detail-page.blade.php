        ...
        <div class="p-4 md:p-5 flex gap-x-4">
          ...
          <div class="grow">
            ...
            <div class="mt-1 flex items-center gap-x-2">
              ...
              <span class="{{ $status }} py-1 px-3 rounded text-white shadow">{{ ucwords($order->status) }}</span>
            </div>  
          </div>
        </div>
      </div>
        ...
        <div class="p-4 md:p-5 flex gap-x-4">
          ...
          <div class="grow">
            ...
            <div class="mt-1 flex items-center gap-x-2">
              ...
              <span class="{{ $payment_status }} py-1 px-3 rounded text-white shadow">{{ ucwords($order->payment_status) }}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col md:flex-row gap-4 mt-4">
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="flex justify-between mb-2">
            <span>Taxes</span>
            <span>{{ Number::currency(0, 'INR') }}</sp</span>
          </div>
          <div class="flex justify-between mb-2">
            <span>Shipping</span>
