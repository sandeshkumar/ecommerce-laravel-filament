    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
      ...
      <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $brand->id }}">
        ...
        <div class="p-5 text-center">
          <a wire:navigate href="/products?selected_brands[0]={{ $brand->id }}" class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-300">
            {{ $brand->name }}
          </a>
        </div>
      </div>
        ...
        <div class="p-4 md:p-5">
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              ...
              <div class="ms-3">
                <h3 wire:navigate class="group-hover:text-blue-600 font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                  {{ $category->name }}
                </h3>
              </div>
            </div>
